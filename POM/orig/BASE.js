// POM.BASE
// Contains all the static data we refer back to for redundant calculations,
...
POM.BASE = {
    ...
    dirs: {
		...
		// I don't remember how these work off the top of my head, they may be unnecessary.
        octants: {
            N:  {x:  1, y: -1},
            NE: {x:  1, y: -1},
            E:  {x:  1, y:  0},
